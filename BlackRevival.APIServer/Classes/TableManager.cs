...
public static class TableManager
{
    ...
    public static void Init()
    {
        ...
        json = System.IO.File.ReadAllText("Data/GameDB/product.json");
        //Serailize json to ProductDB
        Log.Information("Loading product.json...");
        productsDb = new ProductDB(JsonSerializer.Deserialize<ProductDB.Model>(json));

        json = System.IO.File.ReadAllText("Data/GameDB/MiniLeague.json");
        //Serailize json to MiniLeagueDB
        Log.Information("Loading MiniLeague.json...");
        miniLeagueDb = new MiniLeagueDB(JsonSerializer.Deserialize<MiniLeagueDB.Model>(json));
        ...
        var res = JsonSerializer.Deserialize<ProductAllResult>(jsonString);
        ...
        //ConstantsDB
        json = System.IO.File.ReadAllText("Data/GameDB/constants.json");
        ...
        //ExpeditionSkillDB
        json = System.IO.File.ReadAllText("Data/GameDB/expeditionSkill.json");
        ...
        //ExpeditionUnitDB
        json = System.IO.File.ReadAllText("Data/GameDB/expeditionUnit.json");
        //Serialize json to ExpeditionUnitDB
        Log.Information("Loading expeditionUnit.json...");
        expeditionUnitDb = new ExpeditionUnitDB(JsonSerializer.Deserialize<ExpeditionUnitDB.Model>(json));

        //ExpeditionEventDB
        json = System.IO.File.ReadAllText("Data/GameDB/expeditionEvent.json");
        //Serialize json to ExpeditionUnitDB
        Log.Information("Loading expeditionEvent.json...");
        expeditionEventDb = new ExpeditionEventDB(JsonSerializer.Deserialize<ExpeditionEventDB.Model>(json));

        //ExpeditionAreaDB
        json = System.IO.File.ReadAllText("Data/GameDB/expeditionArea.json");
